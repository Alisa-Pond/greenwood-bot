...
# ВАЖЛИВО:
#
# Цей roll визначає ТІЛЬКИ КІЛЬКІСТЬ предметів.
#
# ЯКИЙ саме предмет випаде,
# визначає services/loot.py
# через ваги конкретних предметів.
#
# Окремого roll на rarity більше НЕМАЄ.
#
# =========================================================
...
def complete_plant(message):
    ...
    # КРОК 1:
    #
    # Визначаємо КІЛЬКІСТЬ предметів.
    #
    # 🌱 Рослина:
    #
    # 20% → 1 предмет
    ...
    #
    # Якщо предмет випав,
    # services/loot.py робить roll конкретного
    # предмета без окремого roll на rarity.
    #
    # Предмет визначається його вагою.
    #
    # =====================================================
