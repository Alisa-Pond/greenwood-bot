...
def complete_plant(message):
    ...
    # =====================================================
    #
    # Використовуємо ЄДИНИЙ loot.py.
    #
    # world_conditions.py визначає:
    #
    # 🌞 день
    # 🌙 ніч
    # 🌕 повню
    # 📖 активну главу
    #
    # loot.py вже сам вирішує:
    #
    # • які пули доступні;
    # • які предмети доступні;
    # • яку вагу має кожен предмет.
    #
    # Тут ми лише передаємо актуальні умови.
    # =====================================================
