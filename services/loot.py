...
# =========================================================
#
# Один каталог використовується всіма активностями:
#
# 🧭 Експедиції
# 📜 Сувої
# 🔄 Ритуали
...
# ВАЖЛИВО:
#
# rarity НЕ використовується для roll випадіння.
#
# rarity = характеристика предмета
#
# weights = реальна вага предмета під час випадіння.
#
# Тобто якщо предмет уже має шанс бути отриманим,
# вибір конкретного предмета відбувається безпосередньо
# через його вагу.
#
# =========================================================
...
def is_item_available(
    ...
    # -----------------------------------------------------
    #
    # Предмет, який має full_moon,
    # але НЕ має main/night,
    # доступний тільки під час повні.
    #
    # -----------------------------------------------------
    ...
    # -----------------------------------------------------
    #
    # Предмет тільки з night
    # не може випадати вдень.
    #
    # -----------------------------------------------------
...
# ВАЖЛИВО:
#
# Тут більше НЕМАЄ roll на rarity.
#
# Якщо complete_* уже визначив, що предмет має випасти,
# ця функція одразу вибирає конкретний предмет
# за його вагою.
#
# Наприклад:
#
...
# C = 5 / 45
#
# Тобто ваги є відносними і не повинні складати 100.
#
# =========================================================
...
# =========================================================
#
# amount визначає, скільки окремих rolls зробити.
#
# Наприклад:
#
# roll_loot_many(1)
#
# → один roll → один предмет
#
#
# roll_loot_many(2)
#
...
# → roll №2 → предмет
#
# Тому два предмети МОЖУТЬ бути однаковими.
#
# =========================================================
