...
# =========================================================
#
# ЦЕ НЕ ШАНС ВИПАДАННЯ ЛУТУ.
#
# Це другий roll:
#
# 1) complete_* спочатку вирішує:
#       випав лут чи ні
#
# 2) якщо лут випав:
#       roll_rarity()
...
#
# ВАЖЛИВО:
# Сума тут не повинна дорівнювати 100.
# random.choices працює з відносними вагами.
#
# =========================================================
...
# =========================================================
# 🎲 ROLL ПРЕДМЕТА ПЕВНОЇ РІДКІСНОСТІ
# =========================================================

def roll_item_by_rarity(
    rarity,
    conditions=None
):
...
# =========================================================
#
# Це ВНУТРІШНІЙ повний цикл:
#
# 1. Roll rarity
# 2. Roll item
#
# Сам шанс 20% / 80% тут НЕ робиться.
#
# Його роблять complete_*.
#
# =========================================================
...
def roll_loot(
    ...
    item_id = roll_item_by_rarity(
        rarity,
        conditions
    )

    # -----------------------------------------------------
    # Якщо конкретної рідкісності зараз немає
    # -----------------------------------------------------
    #
    # Наприклад:
    # випала legendary,
    # але в поточному пулі немає legendary.
    #
    # Щоб гравець не отримав "нічого"
    # через відсутність предмета,
    # робимо fallback.
    #
    # -----------------------------------------------------
